...
export default (req, res) => {
  ...
  const data = {
    to: ["sanam@skywarddigital.com.au"],
...
`;
    ...
    body["page"] === "/web-design-melbourne" ||
    body["page"] === "/wordpress-web-design" ||
    body["page"] === "/ecommerce-website-design" ||
    body["page"] === "/business-website-design" ||
    body["page"] === "/educational-website-design" ||
    body["page"] === "/medical-website-design"
  ) {
    userMessage = `
Hey ${body["Full Name"]}\n
...
Ashley V.\n
    ...
    body["page"] === "/pricing" && body["Business Goals"] === "White Label Services"
      ? (userMessage = `
